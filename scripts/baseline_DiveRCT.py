...
# %%
set_seed(args.seed)
LOG_TITLE = f"baseline_DiveRCT_{args.seed}_{args.data_path[-8:-4]}_{args.system_prompt}_{args.victim_model}"
consis_thre = 0.
div_thre = 0.4
DELAY_STEP = 0
...
lagrange_multipliers = {
    "non_gibberish": LagrangeMultiplier(name="non_gibberish", initial_value=1.0, lr=0.2, momentum=0.1, 
                               ...
                               inverse_fn=torch.log, device=train_device, is_main_process=True),
